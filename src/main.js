...
function fetchPage(url) {
    var HTMLData = axios_1.default
        .get(url)
        .then(function (res) { return res.data; })
        .catch(function (error) {
        var _a;
        console.error("There was an error with ".concat((_a = error === null || error === void 0 ? void 0 : error.config) === null || _a === void 0 ? void 0 : _a.url, "."));
...
function extractData(document) {
    var writingLinks = Array.from(document.querySelectorAll('a.titlelink'));
...
function getData() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, fetchFromWebOrCache('https://news.ycombinator.com/', true)];
                case 1:
                    document = _a.sent();
                    console.log("check");
